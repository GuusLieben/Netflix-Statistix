...
public abstract class CreationFrame extends JFrame {
  ...
  HashMap<String, JComboBox> comboValues = new HashMap<>();
  ...
  JComboBox<String> generateDropDown(String str, List<String> list) {
    String[] arr = new String[list.size()];
    for (int i = 0; i < list.size(); i++) arr[i] = list.get(i);
    return addDropDown(str, arr);
  }

  JComboBox<String> addDropDown(String str, String[] arr) {
  ...
  void addButton(Common.NButton btn) {
