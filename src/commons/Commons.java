...
public class Commons {
  ...
  public static void purgeLogs() {
    ...
    double numDays = Double.parseDouble(DataHandle.get("logs.purgeDays"));
    ...
    if (files != null) {
      for (File file : files) {
        ...
        if (file.isFile() && file.getName().contains(".log")) {
          double difference = new Date().getTime() - file.lastModified();
          double purgeTime = (numDays * (24 * 60 * 60 * 1000));
